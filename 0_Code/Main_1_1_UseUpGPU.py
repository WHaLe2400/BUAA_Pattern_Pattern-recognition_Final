"""
加入了transformer机制，但是troch并没有更新，所以效率相对低了很多
将train文件夹整个作为训练集，使用RESULT_6文件夹输出

输出RESULT_6.2，这个模型的参数量太大了，完全没法部署，跪求一张RTX6000（划掉
"""
...
class Net(nn.Module):
    def __init__(self, 
        ...
        super().__init__()
        self.block1 = ConvTransBlock(3, 32, conv_size, seq_len = 188*188, embed_dim= 32)
...
if __name__ == '__main__':
    ...
    fileroot_process="E:\\0_STUDY!\\7_Pytorch\\SomethingFun\\25-05\\classifier_2\\RESULT_6.2\\1_convX_hidX_process.txt"
    fileroot_model="E:\\0_STUDY!\\7_Pytorch\\SomethingFun\\25-05\\classifier_2\\RESULT_6.2\\Model\\convX_hidX_model_RoundX.pth"
    fileroot_result="E:\\0_STUDY!\\7_Pytorch\\SomethingFun\\25-05\\classifier_2\\RESULT_6.2\\2_convX_hidX_result_RoundX.txt"
    fileroot_evaluate="E:\\0_STUDY!\\7_Pytorch\\SomethingFun\\25-05\\classifier_2\\RESULT_6.2\\3_convX_hidX_evaluate_RoundX.txt"
